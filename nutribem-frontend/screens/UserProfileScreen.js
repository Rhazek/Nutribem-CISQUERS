        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.genderContainer}>
            <TouchableOpacity
              style={[
                styles.genderButton,
                genero === "Masculino" && editing && styles.genderSelected,
                !editing && { backgroundColor: "#eee" }
              ]}
              onPress={() => editing && setGenero("Masculino")}
              disabled={!editing}
            >
              <Text
                style={
                  genero === "Masculino" && editing
            ...
            <TouchableOpacity
              style={[
                styles.genderButton,
                genero === "Feminino" && editing && styles.genderSelected,
                !editing && { backgroundColor: "#eee" }
              ]}
              onPress={() => editing && setGenero("Feminino")}
              disabled={!editing}
            >
              <Text
                style={
                  genero === "Feminino" && editing
                    ? styles.genderTextSelected
                    : styles.genderText
                }
              >
          ...
          {!editing && (
            <TouchableOpacity
              style={[styles.button, { backgroundColor: "#00B140", marginTop: 20 }]}
          ...
          {editing && (
            <TouchableOpacity
              style={[styles.button, { backgroundColor: isFormValid() ? "#00B140" : "#ccc", marginTop: 20 }]}
              onPress={handleSave}
